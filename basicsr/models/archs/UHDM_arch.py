...
from basicsr.models.archs.RetinexFormer_arch import IG_MSA, IGAB

factor = 2


# Define 5 classes, these numbers are determined based on our observations on training set
VALUE_MAP = {
    0.96: 0,
    0.98: 1,
    1.00: 2,
